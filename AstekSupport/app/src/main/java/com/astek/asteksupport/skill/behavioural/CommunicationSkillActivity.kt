...
class CommunicationSkillActivity : AppCompatActivity() {
    ...
    private fun createValueInDB(){
        ...
        addValueInDataBase(skillEvaluation, "communicationSkillEvaluation")
    }
    ...
    private fun updateValueInDB(){
        ...
        updateValueInDataBase(skillEvaluation, "communicationSkillEvaluation", documentUpdateId)
    }
    ...
    private fun retrieveData(){
        ...
        db.collection("users").document(AuthenticationUtil.employeeDocumentId)
            .collection("communicationSkillEvaluation")
            .get()
    ...
    companion object {
        private const val TAG = "CommunicationSkill"
    }
