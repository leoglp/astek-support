...
class EnglishSkillActivity : AppCompatActivity() {
    ...
    private fun createValueInDB(){
        ...
        addValueInDataBase(skillEvaluation, "englishSkillEvaluation")
    }
    ...
    private fun updateValueInDB(){
        ...
        updateValueInDataBase(skillEvaluation, "englishSkillEvaluation", documentUpdateId)
    }
    ...
    private fun retrieveData(){
        ...
        db.collection("users").document(AuthenticationUtil.employeeDocumentId)
            .collection("englishSkillEvaluation")
            .get()
    ...
    companion object {
        private const val TAG = "EnglishSkill"
    }
