...
class AdaptabilitySkillActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_adaptability_skill)
    ...
    private fun createValueInDB(){
        ...
        addValueInDataBase(skillEvaluation, "adaptabilitySkillEvaluation")
    }
    ...
    private fun updateValueInDB(){
        ...
        updateValueInDataBase(skillEvaluation, "adaptabilitySkillEvaluation", documentUpdateId)
    }
    ...
    private fun retrieveData(){
        ...
        db.collection("users").document(AuthenticationUtil.employeeDocumentId)
            .collection("adaptabilitySkillEvaluation")
            .get()
    ...
    companion object {
        private const val TAG = "AdaptabilitySkill"
    }
