...
class BilanFormationActivity : AppCompatActivity() {
    ...
    private fun createValueInDB(){
        ...
        when (numberTarget) {
            ...
            3 -> bilanFormation = hashMapOf(
                "entitled1" to entitledEditText1.text.toString(),
                "date1" to dateEditText1.text.toString(),
                "duration1" to durationEditText1.text.toString(),
                "initiative1" to getStringValue(employerRadioButton1,employeeRadioButton1),
                "implementation1" to implementationEditText1.text.toString(),
                "commentary" to commentaryEditText1.text.toString(),
                ...
                "entitled3" to entitledEditText3.text.toString(),
                "date3" to dateEditText3.text.toString(),
                "duration3" to durationEditText3.text.toString(),
                "initiative3" to getStringValue(employerRadioButton3,employeeRadioButton3),
                "implementation3" to implementationEditText3.text.toString(),
                "commentary3" to commentaryEditText3.text.toString(),
            ...
            .addOnSuccessListener { result ->
                for (document in result) {
                    ...
                    if(numberTarget == 1) {
                        ...
                        if (document.get("entitled3") != null) {
                            entitledEditText3.setText(document.get("entitled3").toString())
                        }
                        if (document.get("date3") != null) {
                            dateEditText3.setText(document.get("date3").toString())
                        }
                        if (document.get("duration3") != null) {
                            durationEditText3.setText(document.get("duration3").toString())
                        }
                        if (document.get("initiative3") != null) {
                            checkedOneButton(document.get("initiative3").toString(),employerRadioButton3,employeeRadioButton3)
                        }
                        if (document.get("implementation3") != null) {
                            implementationEditText3.setText(document.get("implementation3").toString())
                        }
                        if (document.get("commentary3") != null) {
    ...
    private fun updateTargetView() {
        ...
        if(numberTarget == 3) {
            ...
            entitledLayout3.visibility = View.VISIBLE
            dateLayout3.visibility = View.VISIBLE
            durationLayout3.visibility = View.VISIBLE
            initiativeLayout3.visibility = View.VISIBLE
            implementationEditText3.visibility = View.VISIBLE
            implementation3.visibility = View.VISIBLE
            commentaryEditText3.visibility = View.VISIBLE
            commentary3.visibility = View.VISIBLE
        }
    }
    ...
    private fun updateTargetView(isAdded: Boolean) {
        if(isAdded){
            ...
            if(numberTarget == 2) {
                ...
                entitledLayout3.visibility = View.GONE
                dateLayout3.visibility = View.GONE
                durationLayout3.visibility = View.GONE
                initiativeLayout3.visibility = View.GONE
                implementationEditText3.visibility = View.GONE
                implementation3.visibility = View.GONE
                commentaryEditText3.visibility = View.GONE
                commentary3.visibility = View.GONE
            }
        }
    }
    ...
    private fun checkField(numberTarget: Int , it: View){
        when (numberTarget) {
            ...
            3 -> if(entitledEditText1.text.toString().isEmpty() || dateEditText1.text.toString().isEmpty()
                || durationEditText1.text.toString().isEmpty() || implementationEditText1.text.toString().isEmpty()
                || commentaryEditText1.text.toString().isEmpty()
                || entitledEditText2.text.toString().isEmpty() || dateEditText2.text.toString().isEmpty()
                || durationEditText2.text.toString().isEmpty() || implementationEditText2.text.toString().isEmpty()
                || commentaryEditText2.text.toString().isEmpty()
                || entitledEditText3.text.toString().isEmpty() || dateEditText3.text.toString().isEmpty()
                || durationEditText3.text.toString().isEmpty() || implementationEditText3.text.toString().isEmpty()
                || commentaryEditText3.text.toString().isEmpty()) {
                showMessage(it, this.getString(R.string.err_no_input))
            } else {
                createOrUpdate()
                UIUtil.goToNextPage(this, this.javaClass.simpleName)
