...
class TeamWorkSkillActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_team_work_skill)
    ...
    private fun createValueInDB(){
        ...
        addValueInDataBase(skillEvaluation, "teamWorkSkillEvaluation")
    }
    ...
    private fun updateValueInDB(){
        ...
        updateValueInDataBase(skillEvaluation, "teamWorkSkillEvaluation", documentUpdateId)
    }
    ...
    private fun retrieveData(){
        ...
        db.collection("users").document(AuthenticationUtil.employeeDocumentId)
            .collection("teamWorkSkillEvaluation")
            .get()
    ...
    companion object {
        private const val TAG = "TeamWorkSkill"
    }
