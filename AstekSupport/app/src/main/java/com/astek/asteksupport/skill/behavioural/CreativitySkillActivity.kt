...
class CreativitySkillActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_creativity_skill)
    ...
    private fun createValueInDB(){
        ...
        addValueInDataBase(skillEvaluation, "creativitySkillEvaluation")
    }
    ...
    private fun updateValueInDB(){
        ...
        updateValueInDataBase(skillEvaluation, "creativitySkillEvaluation", documentUpdateId)
    }
    ...
    private fun retrieveData(){
        ...
        db.collection("users").document(AuthenticationUtil.employeeDocumentId)
            .collection("creativitySkillEvaluation")
            .get()
    ...
    companion object {
        private const val TAG = "CreativitySkill"
    }
