...
class RespectSkillActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_respect_skill)
    ...
    private fun createValueInDB(){
        ...
        addValueInDataBase(skillEvaluation, "respectSkillEvaluation")
    }
    ...
    private fun updateValueInDB(){
        ...
        updateValueInDataBase(skillEvaluation, "respectSkillEvaluation", documentUpdateId)
    }
    ...
    private fun retrieveData(){
        ...
        db.collection("users").document(AuthenticationUtil.employeeDocumentId)
            .collection("respectSkillEvaluation")
            .get()
    ...
    companion object {
        private const val TAG = "RespectSkill"
    }
