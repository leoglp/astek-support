...
class OthersSkillActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        super.onResume()
        skill1.text = this.getString(R.string.skillOther)
        skill2.text = this.getString(R.string.skillOther)
        skill3.text = this.getString(R.string.skillOther)
    ...
    companion object {
        private const val TAG = "OthersSkill"
    }
