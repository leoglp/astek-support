...
class RigourSkillActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_rigour_skill)
    ...
    private fun createValueInDB(){
        ...
        addValueInDataBase(skillEvaluation, "rigourSkillEvaluation")
    }
    ...
    private fun updateValueInDB(){
        ...
        updateValueInDataBase(skillEvaluation, "rigourSkillEvaluation", documentUpdateId)
    }
    ...
    private fun retrieveData(){
        ...
        db.collection("users").document(AuthenticationUtil.employeeDocumentId)
            .collection("rigourSkillEvaluation")
            .get()
    ...
    companion object {
        private const val TAG = "RigourSkill"
    }
