...
class AutonomySkillActivity : AppCompatActivity() {
    ...
    private fun createValueInDB(){
        ...
        addValueInDataBase(skillEvaluation, "autonomySkillEvaluation")
    }
    ...
    private fun updateValueInDB(){
        ...
        updateValueInDataBase(skillEvaluation, "autonomySkillEvaluation", documentUpdateId)
    }
    ...
    private fun retrieveData(){
        ...
        db.collection("users").document(AuthenticationUtil.employeeDocumentId)
            .collection("autonomySkillEvaluation")
            .get()
